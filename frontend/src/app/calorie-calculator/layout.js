export const metadata = {
  ...
  description: 'Calculate your daily calorie needs based on age, gender, weight, height, and activity level. Free calorie calculator for weight loss, maintenance, or gain.',
